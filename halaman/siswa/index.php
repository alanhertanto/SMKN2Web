        ...
        <div class="wrapper" style="margin-left:-120px;">
          ...
          <div class="content-wrapper">
            ...
            <section class="content">
              ...
              <div class="box">
                <div class="box-body">
                 <button type="submit" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Tambah Data Siswa</button>
                 <br>
                 <br>
                 <div class="box-body">
    ...
    $('#table_cust').DataTable({
      ...
      { "data": "foto",
        render:function ( data, type, row, meta ) {
          return '<img height="140px" width="140px" src="../../assets/img/siswa/'+data+'"/>';
      }},
      { "data": "button"}
      ]
    });
